...
<html dir="ltr" lang="en">
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th>Status (Afternoon)</th>
                          <th>Status (Evening)</th>
                          <th>EditAccount</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                                            ...
                                            echo "<tr><td>" . $row["id"]. "</td><td>" . $row["roomNumber"] . "</td><td>"
                                            . $row["type_id"]. "</td><td>" . $row["status_morning"] . "</td>
                                            <td>" . $row["status_afternoon"] . "</td><td>" . $row["status_evening"] . "</td>
                                            <td>" . "<a href='#' class='hehe'><i class='fas fa-edit' data-toggle='modal'data-target='#updateRoom".$row['id']. "'>Update
                                            </i></a> &nbsp <a href='#' class='hehe'><i class='fas fa-trash-alt' data-toggle='modal' data-target='#deleteRoom". $row['id']. "'>Delete</i></a>". "</td>
                                            </tr>";

                                            $sql2 = "SELECT * FROM tbl_room WHERE id = ' ".$row['id']." ' ";
                                            $result2 = mysqli_query($conn,$sql2);
                                            $row2=mysqli_fetch_assoc($result2);
                                            $room = $row['id'];

                                            echo "<div id='updateRoom".$row['id']."' class='modal fade' role='dialog'>
                                              ...
                                              <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                  ...
                                                  <div class='modal-body p-4 py-5 p-md-5'>
                                                    <h3 class='text-center mb-3'>Update Room</h3>
                                                    <br>
                                                    <form class='signup-form'  method='POST'>
                                                      ...
                                                      <br>
                                                      <div class='form-group mb-2'>
                                                        <button type='submit' class='form-control btn btn-primary rounded submit px-3' name='btnUpdateRoom'>Upate Room</button>
                                                      </div>
                                          ...
                                          echo "<div id='deleteRoom".$row['id']."' class='modal fade' role='dialog'>
                                          ...
                                          <div class='modal-dialog'>
                                            ...
                                            <div class='modal-content'>
                                              ...
                                              <div class='modal-body'>
                                                <div class='modal-body p-4 py-5 p-md-5'>
                                                  <h3 class='text-center mb-3'>Delete Room</h3>
                                                  <br>
                                                  <form class='signup-form'  method='POST'>
                                                      <input type='text' class='form-control' value=' ". $row2["id"] ." ' name='delroomID' hidden>
                                                    <br>
                                                      <input type='text' class='form-control' value=' ". $row2["roomNumber"] ."' name='room_Name' readonly>
                                                    <p> Do you want to delete this Room? </p>
                                                    <div class='form-group mb-2'>
                                                      <button type='submit' class='form-control btn btn-primary rounded submit px-3' name='btnDeleteRoom'>Delete Room</button>
                                                    </div>
                                                  </form>
                                                </div>
          ...
          <div class="modal fade" id="addRoom" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body p-4 py-5 p-md-5">
                  <h3 class="text-center mb-3">Add New Room</h3>
                  <br>
                  <form action="#" class="signup-form"  method="POST">
                    ...
                    <div class="form-group mb-2">
                      <label for="name">type_id</label>
                      <input type="text" class="form-control" placeholder="" name="type_id">
                    </div>
                    <div class="form-group mb-2">
                      <label>Status (Morning) 1-Available 0-Booked</label>
                      <!-- <input type="text" class="form-control" placeholder="" name="status_morning"> -->
                    ...
                    <br>
                    <div class="form-group mb-2">
                      <button type="submit" class="form-control btn btn-primary rounded submit px-3" name="btnAddRoom">Add Room</button>
                    </div>
  ...
  <?php
    if(isset($_POST['btnAddRoom'])){
        ...
        $status_morning=$_POST['status_morning'];
        $status_afternoon=$_POST['status_afternoon'];
        $status_evening=$_POST['status_evening'];
        ...
        $query="INSERT INTO tbl_room (roomNumber, type_id, status_morning, status_afternoon, status_evening) VALUES ('$roomNumber','$type_id', '$status_morning','$status_afternoon', '$status_evening')";
  ...
  if(isset($_POST['btnUpdateRoom'])){
        ...
        $sql3 = mysqli_query($conn,"UPDATE tbl_room set roomNumber='$roomNumber',type_id='$type_id',status_morning='$status_morning',status_afternoon='$status_afternoon',
          status_evening='$status_evening' where id = $id");
        header("Location: room_table.php");

    }
    if(isset($_POST['btnDeleteRoom'])){
            $delroom=$_POST['delroomID'];
            $sql4 = mysqli_query($conn,"DELETE FROM tbl_room WHERE id = $delroom");
            header("Location: room_table.php");
